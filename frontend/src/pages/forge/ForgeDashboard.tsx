    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: 16, padding: 24 }}>
      ...
      <div className="nx-card" style={{ width: '100%', maxWidth: 420, display: 'grid', gap: 12 }}>
        ...
        <div>
          ...
          <style>{`
            .forge-niche-select option { background-color: #07090f; color: #3ddc84; }
            .forge-niche-select option:hover, .forge-niche-select option:focus, .forge-niche-select option:checked {
              background-color: #07090f; background: linear-gradient(#a855f7, #a855f7); color: #a855f7;
            }
          `}</style>
        </div>
      ...
      <nav style={{ borderBottom: '1px solid var(--border)', padding: '0 32px', height: 56, display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'var(--bg2)', position: 'sticky', top: 0, zIndex: 100 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <Link to="/forge/pricing" style={{
            ...
            background: (TIER_COLORS[statut.membre.tier_abonnement] || '#888') + '20',
